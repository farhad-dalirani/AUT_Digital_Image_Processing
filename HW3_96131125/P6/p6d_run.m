...
for i=1:3
    ...
    width = widths(i);
    [img_out, filter_fourier] = p6d_func(img_org, n, width, center);
    ...
    imwrite(filter_fourier, ...
        strcat('p6d_filter_n_', num2str(n), '_width_', num2str(width),'.png'));
    ...
    imwrite(img_out, ...
        strcat('p6d_filtered_img_n_', num2str(n), '_width_', num2str(width),'.png'));
