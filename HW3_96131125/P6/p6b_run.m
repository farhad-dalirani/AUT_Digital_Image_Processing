...
for i=1:3
    ...
    width = widths(i);
    [img_out, filter_fourier] = p6b_func(img_org, n, width);
    ...
    imwrite(filter_fourier, ...
        strcat('p6b_filter_n_', num2str(n), '_width_', num2str(width),'.png'));
    ...
    imwrite(img_out, ...
        strcat('p6b_filtered_img_n_', num2str(n), '_width_', num2str(width),'.png'));
