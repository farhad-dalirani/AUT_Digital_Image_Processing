% Read Image
img_org = imread('vertical_blinds_garden.jpg');
figure();
imshow(img_org);
title('Input Image');
...
%imshow(img_phase)
%title('Phase')
imwrite(log10(img_spectrom/300+1), 'p6c_spectrum.png');
...
figure()
imshow(F_img)
imwrite(F_img, 'p6c_filtered_image.png')
