% Read Image
img_org = imread('vertical_blinds_city.jpg');
figure();
imshow(img_org);
title('Input Image');
...
%imshow(img_phase)
%title('Phase')
imwrite(log10(img_spectrom/300+1), 'p6d_spectrum.png');
...
figure()
imshow(F_img)
imwrite(F_img, 'p6d_filtered_image.png')
